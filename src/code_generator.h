...
class code_generator {
    public:
        ...
        void evaluate_val_expression(parse_tree_node* p);
        void evaluate_val_assignment(parse_tree_node* p);
        void evaluate_val_compexp(parse_tree_node* p);
        void evaluate_val_E(parse_tree_node* p);
        void evaluate_val_T(parse_tree_node* p);
        void evaluate_val_F(parse_tree_node* p);
        void evaluate_val_factor(parse_tree_node* p);
